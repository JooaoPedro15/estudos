...
export const prova1Blueprint: ExamBlueprint = {
      ...
      steps: [
        {
          ...
          kind: 'choice',
          skillId: 'recognize',
          prompt: 'Qual ramo representa o pior caso em Theta?',
          correctOptionId: 'ramo-if',
          options: [
            { id: 'ramo-if', label: 'Ramo do if: Theta(n log n)' },
            { id: 'ramo-else', label: 'Ramo do else: Theta(n)', mistakeTag: 'wrong-case-analysis' },
            { id: 'empate', label: 'Os dois tem o mesmo custo', mistakeTag: 'wrong-case-analysis' },
          ],
          explanation:
            'O laco interno do if divide j por 2 a cada volta (log n voltas) dentro de um laco externo de n voltas: Theta(n log n), maior que o Theta(n) do else.',
        },
        {
          ...
          explanation: 'O ramo else tem um unico laco que decrementa i ate 0: Theta(n).',
        },
      ],
    },
    {
  ...
  return resp;
        ...
        },
        {
          ...
          answers: ['Theta(n)', 'O(n)'],
          mistakeTag: 'wrong-case-analysis',
          explanation: 'mostrarInverso visita cada elemento da fila exatamente uma vez, do ultimo ao primeiro: Theta(n).',
        },
      ],
    },
  ],
