...
export const conectividadeQuestions: Question[] = [
  ...
  },
  {
    ...
    prompt: 'Quantos componentes fortemente conexos tem um grafo dirigido fortemente conexo, e quantos tem um grafo dirigido sem ciclos com n vértices? Justifique.',
    options: [
      { id: 'a', label: 'Fortemente conexo: 1 (todo par de vértices se alcança nos dois sentidos, então todos ficam no mesmo componente). Sem ciclos: n (dois vértices no mesmo componente teriam ida e volta, o que forma um ciclo).' },
      { id: 'b', label: 'Fortemente conexo: n. Sem ciclos: 1.' },
      { id: 'c', label: 'Fortemente conexo: 1. Sem ciclos: 1, porque todo grafo tem pelo menos um componente.' },
      { id: 'd', label: 'Depende do número de arestas nos dois casos.' },
    ],
    correctOptionId: 'a',
    source: { type: 'professor_support_material', file: 'Flash Cards Grafos-1.pdf', note: 'SCC – Kosaraju' },
    hints: ['Componente fortemente conexo = conjunto em que todo par tem caminho de ida e de volta.'],
    solution: 'Fortemente conexo significa que todo par de vértices tem caminho nos dois sentidos, então o grafo inteiro é um único componente fortemente conexo. Num grafo sem ciclos, se dois vértices u ≠ v estivessem no mesmo componente haveria caminho u → v e v → u, e ida + volta formam um ciclo — contradição; logo cada vértice é seu próprio componente: n componentes. Esse é o critério da 2ª estratégia de detecção de ciclo (2026/1-Q4).',
  },
  {
    id: 'euler-01',
  ...
  },
  {
    ...
    sourceStyle: 'old_exam',
    type: 'ORDERING',
    prompt: 'Encontre uma ordenação topológica válida do grafo direcionado acíclico abaixo (pode haver mais de uma correta — o sistema aceita a calculada pelo método de remoção incremental).',
  ...
  },
  {
    ...
    sourceStyle: 'old_exam',
    type: 'NUMBER_INPUT',
    prompt: 'No mesmo grafo direcionado acíclico, qual o comprimento (em nº de arestas) do MAIOR caminho que termina em "g"?',
    displayGraphs: { a: DAG_SEVEN },
